 ...
 * @author Ihc
 */
public class 對照字體 extends 合併字體
{
	...
	/** 宋體字體的物件 */
	static private final 對照字體 吳守禮注音摻宋體字體;
	static
	{
		...
		吳守禮注音摻楷體字體 = new 對照字體(楷體字體位址表, 注音字體對照表);
		吳守禮注音摻宋體字體 = new 對照字體(宋體字體位址表, 注音字體對照表);
	}
	 ...
	 *            統一碼佮逐个字體內部編碼對照表。若無需要，彼格傳<code>null</code>
	 */
	protected 對照字體(合併字體 字體, ArrayList<HashMap<Integer, Integer>> 對照表集)
	{
		字體集 = 字體.字體集;
		this.對照表集 = 對照表集;
	}
	 ...
	 *            統一碼佮逐个字體內部編碼對照表。若無需要，彼格傳<code>null</code>
	 */
	public 對照字體(String[] 字體位置, ArrayList<HashMap<Integer, Integer>> 對照表集)
	{
		super(字體位置);
		this.對照表集 = 對照表集;
	}
	...
	@Override
	public 對照字體 調整字體大小(float 字體大小)
	{
		return new 對照字體(super.調整字體大小(字體大小), 對照表集);
	}

	@Override
	public 對照字體 調整字體選項(int 字體選項)
	{
		return new 對照字體(super.調整字體選項(字體選項), 對照表集);
	}

	@Override
	public 對照字體 調整字體參數(int 字體選項, float 字型大小)
	{
		return new 對照字體(super.調整字體參數(字體選項, 字型大小), 對照表集);
	}
	...
	static private HashMap<Integer, Integer> 產生吳守禮注音字體對照表()
	{
		...
		吳守禮注音字體對照表.put(0x02ea, 0xb382);
		吳守禮注音字體對照表.put(0x02eb, 0xb383);
	 ...
	 */
	static public 對照字體 提著吳守禮注音摻楷體字體()
	{
		return 吳守禮注音摻楷體字體;
	}
	 ...
	 * @return　吳守禮注音佮全字庫、構形資料庫公家機關提來的楷體字體
	 */
	static public 對照字體 提著吳守禮注音摻宋體字體()
	{
		return 吳守禮注音摻宋體字體;
	}
}
