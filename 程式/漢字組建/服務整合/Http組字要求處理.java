...
public class Http組字要求處理 extends HttpServlet
{
	...
	/** 組宋體粗體用的工具 */
	protected 組字服務 粗宋組字工具;
	/** 組楷體用的工具 */
	protected 組字服務 楷體組字工具;
	/** 組楷體粗體用的工具 */
	protected 組字服務 粗楷組字工具;
	...
	public Http組字要求處理()
	{
		...
		粗宋組字工具 = new 組字服務(查詢方式, 正規化工具, 粗宋設定工具, 調整工具, 活字加粗, 粗字型屬性, 字型大細);
		...
		楷體組字工具 = new 組字服務(查詢方式, 正規化工具, 楷體設定工具, 調整工具, 活字加粗, 普通字型屬性, 字型大細);
		...
		粗楷組字工具 = new 組字服務(查詢方式, 正規化工具, 粗楷設定工具, 調整工具, 活字加粗, 粗字型屬性, 字型大細);
	}
