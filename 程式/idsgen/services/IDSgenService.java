...
import idsgen.parser.IDSExecption;
...
public class IDSgenService
{
	 ...
	 *            字體愛偌大
	 */
	public IDSgenService(ExpSequenceLookup 查詢方式, IDSnormalizer 正規化工具,
	...
	public static IDSgenService 預設組字服務()
	{
		return 預設組字服務(200);
	}

	public static IDSgenService 預設組字服務(int 字型大細)
	{
		int 普通字型屬性 = 0;
		...
		return new IDSgenService(查詢方式, 正規化工具, 宋體設定工具, 調整工具, 活字加粗, 普通字型屬性, 字型大細);
	}
