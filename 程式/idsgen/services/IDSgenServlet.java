 ...
 * @author Ihc
 */
public class IDSgenServlet extends HttpServlet
{
	/** 序列化編號 */
	...
	/** 組宋體粗體用的工具 */
	protected IDSgenService 粗宋組字工具;
	/** 組楷體用的工具 */
	protected IDSgenService 楷體組字工具;
	/** 組楷體粗體用的工具 */
	protected IDSgenService 粗楷組字工具;
	...
	public IDSgenServlet()
	{
		...
		粗宋組字工具 = new IDSgenService(查詢方式, 正規化工具, 粗宋設定工具, 調整工具, 活字加粗, 粗字型屬性, 字型大細);
		...
		楷體組字工具 = new IDSgenService(查詢方式, 正規化工具, 楷體設定工具, 調整工具, 活字加粗, 普通字型屬性, 字型大細);
		...
		粗楷組字工具 = new IDSgenService(查詢方式, 正規化工具, 粗楷設定工具, 調整工具, 活字加粗, 粗字型屬性, 字型大細);
	}
