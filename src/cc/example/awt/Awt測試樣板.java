...
abstract public class Awt測試樣板 extends JPanel
{
	...
	/** 測試漢字 */
	static String word = /* "    ⿰禾火秋⿰⿰火牙阝"; */"一百二十三尺意" + "秋漿國變務森" + "⿰禾火⿱將水⿴囗或"
			+ "⿱⿰⿰糹言糹攵⿰矛⿱攵力⿱攵力⿱木⿰木木" + "⿱立⿱日十⿱⿱立日十章輻⿰車⿱一⿱口田⿰⿱十⿱田十⿱一⿱口田"
			+ "⿱口⿰口口⿱夕夕，" + "⿴辶⿴宀⿱珤⿰隹⿰貝招⿴辶咼辶" + "⿴冖儿⿴冖几宀寶建⿴廴聿"
			+ "⿴厂猒⿴广夏⿴疒丙⿴尸古⿴戶方⿴户方⿴户 ⿱户　⿰户　" + "⿴气亥⿴气乃⿴气亞"
			+ "⿴冂⿱一口⿴冂⿱儿口⿴門一⿴門日⿴門月⿴鬥月⿴鬥市⿴鬥一" + "⿱⿴乃又皿盈孕⿴乃子⿱乃子"
			+ "⿴凵乂⿴凵⿰幺⿰丨幺⿴凵⿰豕⿰丨豕" + "⿴勹日⿰⿴弓土畺⿴匚甲⿴⼖⿱口⿰口口⿰懸一⿱闊一⿰懸丨⿱闊丨"
			+ "⿰彳⿱羊羊⿱羊⿰羊羊⿱⿰羊羊⿰羊羊⿰⿱羊羊⿱羊羊⿰丨丨丨"
			+ "⿳⿳⿳˙ㄆㄨˊ⿳⿳ㄅㄧㄚ⿳ㆬㆷ";// */;
	/** 全字庫正宋體 */
