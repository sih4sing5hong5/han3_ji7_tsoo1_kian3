...
/**
 * 適用於平推後外部部件有上下左三邊的活字接合，如「⿴匚甲」為「匣」。在接合時，都固定外部活字，並將內部活字固定在右中縮放。
 * 
 * @author Ihc
 */
public class TBLSurroundAsmmod extends ZoomAsmmod
{
	/**
	 * 建立上下左三邊接合模組
	 * 
	 ...
	 */
	public TBLSurroundAsmmod(MergePieceAdjuster 調整工具)
	{
		super(調整工具);
	}
